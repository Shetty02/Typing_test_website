  ...
  return (
    ...
    {gameMode === 'time'?(<div className="counter">{countDown} s</div>) : (<></>)} 
      ...
      <div className="word-mode">
            <div className="no-of-word" id='10' onClick={(e)=>updateWords(e)}>10</div>
            <div className="no-of-word" id='20' onClick={(e)=>updateWords(e)}>20</div>
            <div className="no-of-word" id='30' onClick={(e)=>updateWords(e)}>30</div>
      </div>
)}
    </div>
  )
